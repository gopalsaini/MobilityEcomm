               ...
               <div class="row align-items-center row-md-reverse">
                  ...
                  <div class="col-lg-7">
                     <div class="contact__form">
                           <form action="{{ route('contact-us') }}" method="post"  id="contactUs" class="formsubmit">
                           @csrf
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-6 col-md-6">
                                       <div class="contact__form--list mb-20">
                                          ...
                                          <input class="contact__form--input" name="subject" id="input2" placeholder="Enter Subject" type="text">
                                       </div>
                                 </div>
                                 <div class="col-12">
