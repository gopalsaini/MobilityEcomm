                        ...
                        <div class="panel-heading   " >
                            <div class="row display-tr text-center" >
                                ...
                                <div class="display-td" >                            
                                    <img class="img-responsive pull-right" src="{{asset('images/CreditCard.jpg')}}" style="width:150px">
                                </div>
                            </div>                    
                        </div>
                        <br><br>
                        <div class="panel-body" >
                            ...
                            <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                                ...
                                <div class="card-footer">
                                    ...
                                    > Pay Now  &nbsp;&nbsp;<pre class="spinner-border spinner-border-sm checkoutloader" style="color:white;font-size: 100%;position:relative;top:6%;display:none"></pre>
                                    </button>
                                </div>
