                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{ asset('assets/img/banner/banner6.webp')}}" alt="banner-img">
                    ...
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{ asset('assets/img/banner/banner8.webp')}}" alt="banner-img">
									...
									<div class="product__items ">
										...
										<div class="product__items--content text-center">
											...
											<a class="product__items--action__cart--btn primary__btn  " href="javascript:void(0)" >
												<i class="fa @if(\App\Helpers\commonHelper::checkWishlistProduct($topselling['variant_productid'])) fa-heart @else fa-heart-o @endif wishlist" data-productid="{{ $topselling['variant_productid'] }}" style="font-size:16px;line-height: 2;"></i>
											</a>
										</div>
									</div>
