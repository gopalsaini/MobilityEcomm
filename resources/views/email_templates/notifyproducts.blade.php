        ...
        <tr>
            <td>
                <table style="text-align: center; background: #fff;padding: 0 25px 30px; width: 100%;">
                    ...
                    <tr>
                        <td>
                            <h4 style="margin:20px 0 8px 0;color: #000;font-size: 22px;font-weight: 700;">Notify Product</h4>
                            <h6 style="margin-top: 0;font-size: 12px;font-weight: 500;">You have notified {{ asset('product-detail') }}/{{ $slug }} for this product. That product is now in stock so please click on this link and countinue shopping.
                            </h6>
                        </td>
                    </tr>
                    <tr>
