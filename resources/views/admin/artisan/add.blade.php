	...
	<div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/artisan/list')}}">
                                <i class="fa fa-list"></i> Artisan List 
							</a>
                        </div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> @if(!empty($result)) Update @else Add @endif Artisan</h2>
					</div>
					<div class="body">
						<form id="form" action="{{ route('admin.artisan.add') }}" method="post" enctype="multipart/form-data"  autocomplete="off">
						@csrf
							...
							<div class="col-sm-12">
								<div class="form-group">
									<div class="form-line">
										...
										<p style="color:red;width:100%">Recommended size 155*156</p>
									</div>
								</div>
