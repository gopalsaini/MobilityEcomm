    ...
    <div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/artisan/add') }}">
                                <i class="fa fa-plus"></i> Add Artisan 
							</a>
                        </div>
					</div>
				</div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Artisan List</h2>
					</div>
                    <div class="body">
                        <div class="table-">
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd">
															...
															<td class="center">
																<img src="{{ asset('uploads/artisan/'.$value['image'] )}}" style="width:100px"/>
															</td>
															...
															@if(\Auth::user()->designation_id=='1' || \Auth::user()->designation_id=='4')
																...
																<td class="center">
																	...
																	<a href="{{ url('admin/artisan/update/'.$value['id'] )}}" title="Update Artisan" class="btn btn-tbl-edit">
																		<i class="fas fa-pencil-alt"></i>
																	</a>
																	<a title="Delete Artisan" onclick="return confirm('Are you sure? You want to delete this artisan.')" href="{{ url('admin/artisan/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
    ...
    <script>
        $('.-change').change(function() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ route('admin.artisan.changestatus') }}",
				headers: {
