    ...
    <div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/catalog/product-collection/add') }}">
                                <i class="fa fa-plus"></i> Add Collection Product
							</a>
                        </div>
					</div>
				</div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Collection Product List </h2>
					</div>
                    <div class="body">
                        <div class="table-">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 193.017px;"
                                                        aria-label=" Email : activate to sort column ascending"> Price
                                                    </th>
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 193.017px;"
														...
														<tr class="gradeX odd">
															...
															@if(\Auth::user()->designation_id=='1' || \Auth::user()->designation_id=='4')
																...
																<td class="center">
																	...
																	<a href="{{ url('admin/catalog/product-collection/update/'.$value['id'] )}}" title="Update Collection Product" class="btn btn-tbl-edit">
																		<i class="fas fa-pencil-alt"></i>
																	</a>
																	<a title="Delete Collection Product" onclick="return confirm('Are you sure? You want to delete this collection.')" href="{{ url('admin/catalog/product-collection/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
