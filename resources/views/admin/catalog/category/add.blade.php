								...
								<div class="form-group">
									<div class="form-line">
										...
										<select class="form-control" name="business_type">
											...
											<option value="Interior Design Studio" @if(!empty($result) && $result['business_type']=='Interior Design Studio') {{ 'selected' }} @endif>Interior Design Studio</option>
											<option value="Other" @if(!empty($result) && $result['business_type']=='Other') {{ 'selected' }} @endif>All</option>
