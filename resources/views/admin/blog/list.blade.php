    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Blog List</h2>
					</div>
                    <div class="body">
                        <div class="table-">
                                        ...
                                        <table class="table table-hover js-basic-example contact_list dataTable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        ...
                                                        aria-label=" Mobile : activate to sort column ascending">  Tags
                                                    </th>
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd">
															...
															<td class="center">
																<img src="{{ asset('uploads/blog/'.$value['image'] )}}" style="width:60px"/>
															</td>
															<td class="center">{{ ucfirst($value->title) }}</td>
															<td class="center">{{ $value->tags }}</td>
															...
															@if(\Auth::user()->designation_id=='1' || \Auth::user()->designation_id=='4')
																...
																<td class="center">
																	...
																	<a href="{{ route('admin.blog.update', ['id' => $value['id']] )}}" title="Update Blog" class="btn btn-tbl-edit">
																		<i class="fas fa-pencil-alt"></i>
																	</a>
																	<a title="Delete Blog" onclick="return confirm('Are you sure? You want to delete this Blog.')" href="{{ route('admin.blog.delete', ['id' => $value['id']] )}}" class="btn btn-tbl-delete">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="center" rowspan="1" colspan="1"> Tags </th> 
													@if(\Auth::user()->designation_id=='1' || \Auth::user()->designation_id=='4')
