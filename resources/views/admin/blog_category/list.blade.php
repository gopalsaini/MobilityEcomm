												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd">
															...
															<td class="center">{{ \App\Helpers\commonHelper::getCategoryNameById($value->parent_id); }}</td>
															...
															@if(\Auth::user()->designation_id=='1' || \Auth::user()->designation_id=='4')
																...
																<td class="center">
																	...
																	<a href="{{ route('admin.category.update', ['id' => $value['id']] )}}" title="Update Testimonial" class="btn btn-tbl-edit">
																		<i class="fas fa-pencil-alt"></i>
																	</a>
																	<a title="Delete Category" onclick="return confirm('Are you sure? You want to delete this Category.')" href="{{ route('admin.category.delete', ['id' => $value['id']] )}}" class="btn btn-tbl-delete">
    ...
    $(document).ready(function(){
        ...
        $('.-change').change(function(){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ route('admin.blog.category.changestatus') }}",
                headers: {
