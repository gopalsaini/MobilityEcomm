					...
					<div class="body">
						...
						<div class="row clearfix">
							<div class="col-sm-12">
								<div class="form-group">
									<div class="form-line">
										<label for="inputName">Href <label class="text-danger">*</label></label>
										<input type="url" name="href" required class="form-control" placeholder="Enter Href" value="@if(!empty($result)){{ $result['link'] }}@endif"/>
									</div>
								</div>
							</div>
						</div>
