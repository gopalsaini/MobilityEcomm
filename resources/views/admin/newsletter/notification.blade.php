	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Send Notification </h2>
					</div>
					<div class="body">
						<form id="form" action="{{ route('admin.notification.send') }}" method="post" enctype="multipart/form-data" autocomplete="off">
							@csrf
							...
							<div class="row clearfix">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label for="inputName" style="display:block">Select Admin <label class="text-danger">*</label></label>
										<select class="selectbox" class="" name="admin[]" multiple>
