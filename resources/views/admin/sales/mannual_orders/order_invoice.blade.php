			...
			<td style="padding: 0 30px 0;">
				<table style="text-align:left;background: #fff;width: 100%;border:1px solid #111;border-top:0;border-collapse: collapse;">
					...
					<tr> 
						...
						<td style="border: 1px solid #111;border-top:0;border-bottom:0;padding: 0 8px;text-align:right"><p style="font-size: 12px;margin: 5px 0;">{{ \App\Helpers\commonHelper::getpriceIconByCountry($sale['net_total'],$result['currency_id']) }}</p></td>	
					</tr>
					@endforeach 
					<tr> 
						...
						<td style="border-bottom: 1px solid #111;"></td> 
						<td style="border-bottom: 1px solid #111;"></td> 
						<td style="border: 1px solid #111;padding: 0 8px;"><p style="font-size: 12px;margin: 5px 0;"><strong>Shipping Charge</strong></p> </td> 
						<td style="border: 1px solid #111;padding: 0 8px;text-align:right"><p style="font-size: 12px;margin: 5px 0;">{{ \App\Helpers\commonHelper::getpriceIconByCountry($result['shipping_amount'],$result['currency_id'])   }}</p></td> 
					</tr>
					<tr> 
						<td style="border-bottom: 1px solid #111;"></td> 
						<td style="border-bottom: 1px solid #111;"></td> 
						...
						<td style="border-bottom: 1px solid #111;"></td> 
						<td style="border-bottom: 1px solid #111;"></td> 
						<td style="border: 1px solid #111;padding: 0 8px;"><p style="font-size: 12px;margin: 5px 0;"><strong>Round Off</strong></p> </td> 
						<td style="border: 1px solid #111;padding: 0 8px;text-align:right"><p style="font-size: 12px;margin: 5px 0;">
							@php
								if(round((round($result['nettotal'])-$result['nettotal']),2)<0){

									echo \App\Helpers\commonHelper::getpriceIconByCountry(round((round($result['nettotal'])-$result['nettotal']),2),$result['currency_id']);
