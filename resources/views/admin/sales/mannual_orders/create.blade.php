                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="name" id="select" class="form-control select" required>
                                            ...
                                            <table style="width:100%" class="table in-table" id="mannualProduct">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select name="variant_product[]" id="select" class="form-control select">
                                                                    <option value="">Select Products</option>
                                                                    @if(!empty($products))
                                                                        @foreach($products as $key=>$value)
             
                                                                            <option value="{{$value->id}}" >{{$value->name}}-{{$value->sku_id}} </option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                            </div>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td class="d-flex align-items-center"><span class="preicon">₹</span>&nbsp; <input type="tel" class='form-control shipping_amount'
                                                                    onchange="calculateCalculation()"
                                                                    onkeypress="return /[0-9 ]/i.test(event.key)"
                                                                    placeholder="Shipping Amount" required
                                                                    name="shipping_amount" value="0"/>&nbsp;<span
                                                                class="posticon"></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" class="border-0"></td>
                                                        <td><b>Round Off &nbsp; <span style="color:red">(-/+)</span></b></td>
                                                        <td><span class="preicon">₹</span> <span
                                                                id="roundAmount">0</span> <span
                                                                class="posticon"></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" class="border-0"></td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.addNewProduct').click(function () {
            ...
            html +='<select class="form-select product select" aria-label="Default select example" required name="variant_product[]"> <option value="" disabled selected >--Select--</option> @foreach($products as $product) <option value="{{ $product->id}}">{{$product->name}}-{{$product->sku_id}}</option> @endforeach </select>';
            html += '</div>';
            html += '</td>';
            html += '<td>';
            html += '<div class="form-group">';
    ...
    function calculateCalculation() {
        ...
        netTotalAmount+=parseFloat($('.shipping_amount').val());

        preRoundOffAmount=netTotalAmount;
        netTotalAmount=Math.round(netTotalAmount);

        $('#roundAmount').html((netTotalAmount-preRoundOffAmount).toFixed(2));
