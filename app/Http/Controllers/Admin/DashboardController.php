...
class DashboardController extends Controller
{
    ...
    public function index(){
        ...
        $totalPendingOrder=\App\Models\Sales::where('sales_details.order_status','1')->where('sales_details.payment_status','2')->join('sales_details','sales_details.sale_id','=','sales.id')->groupBy('sales_details.order_id')->get()->count();

        $totalConfirmedOrder=\App\Models\Sales::where('sales_details.order_status','2')->join('sales_details','sales_details.sale_id','=','sales.id')->groupBy('sales_details.order_id')->get()->count();
        
        $totalShippedOrder=\App\Models\Sales::where('sales_details.order_status','10')->join('sales_details','sales_details.sale_id','=','sales.id')->groupBy('sales_details.order_id')->get()->count();
       
        $totalDeliveredOrder=\App\Models\Sales::where('sales_details.order_status','9')->join('sales_details','sales_details.sale_id','=','sales.id')->groupBy('sales_details.order_id')->get()->count();
